...
create table Serie
(id integer NOT NULL AUTO_INCREMENT, name varchar(150),mri_name varchar(50),repetitiontime float, echotime float, slicethickness float, voxelwidth float, voxelheight float, hasnifti integer(1),impossibleNiftiConversion integer(1), id_project integer,id_patient integer,id_acqdate integer,id_protocol integer,
