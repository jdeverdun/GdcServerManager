...
create table User
(id integer NOT NULL AUTO_INCREMENT, nom varchar(20), prenom varchar(20), email varchar(60), login varchar(30), password varchar(50), constraint user_pk primary key (id));

create table Project
(id integer NOT NULL AUTO_INCREMENT, nom varchar(70),constraint project_pk primary key (id));
