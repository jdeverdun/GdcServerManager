...
constraint uprojet_name unique(name,id_project),
...
constraint upatient_projet_name unique(name,id_project,id_patient),
...
constraint uacqdata_patient_projet_name unique(name,id_project,id_patient,id_acqdate),
...
constraint uprot_acqdata_patient_projet_name unique(name,id_project,id_patient,id_acqdate,id_protocol),
...
constraint uprot_acqdata_patient_projet_name unique(name,id_project,id_patient,id_acqdate,id_protocol,id_serie),
