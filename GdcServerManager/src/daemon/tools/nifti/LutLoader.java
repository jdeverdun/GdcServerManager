...
public class LutLoader {
	...
	// liste les LUT dispo
	public enum ALUT{invert,fire,grays,ice,spectrum,RGB,red,green,blue,cyan,magenta,yellow,redgreen};
	...
	public void run(ImagePlus imp, ALUT cmap) {
	...
	void showLut(ImagePlus imp,FileInfo fi) {
		if (imp!=null) {
